...
export default function Home() {
  ...
  if (!categoriesData){
    return <>Det finns inga behandlingar</>
  }

  return (
    <main className="w-full flex flex-col justify-center items-center p-10">
      ...
      <section ref={categoriesRef} className="flex flex-col items-center">
        <Perks />
        <Categories ref={categoriesRef} categoriesData={categoriesData}/>
        <Contact />
      </section>
